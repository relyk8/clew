...
def _bridge_array_candidate():
    ...
    return {
        "call_site_va": "0x004595fc", "function_va": "0x00459500",
        "api_name": "GetModuleHandleW", "api_resolution": "import",
        "parameter_index": 0, "comparison_operator": "unknown",
        "candidate_values": [
            {"value": "sbiedll.dll", "represents": "unknown", "retarget_to": None,
             "confidence": 0.9, "source_channels": ["bn_xref", "floss"]},
            {"value": "dbghelp.dll", "represents": "unknown", "retarget_to": None,
             "confidence": 0.9, "source_channels": ["bn_xref", "floss"]},
        ],
        "evidence": {"channels": ["bn_xref", "floss"], "string_source": "static",
                     "string_va": None, "string_function_va": None,
                     "dataflow_path": ["0x004595f7", "0x004595fb", "0x004595fc"],
                     "cmp_operand_a": None, "cmp_operand_b": None},
    }
...
def _oracle_array_candidate(values=("SbieDll.dll", "dbghelp.dll")):
    ...
    return {
        "call_site_va": "0x004595fc", "function_va": "0x00459500",
        "api_name": "GetModuleHandleW", "api_resolution": "import",
        "parameter_index": 0, "comparison_operator": "equality",
        "evasion_tier": "tier_1", "iteration_number": 0,
        "candidate_values": [
            {"value": v, "represents": "sandbox_detected", "retarget_to": None,
             "confidence": 0.9, "source_channels": ["floss", "bn_xref"]}
            for v in values
        ],
        "coordination_constraint": {"gate_group_id": "modnames", "description": "OR over module names"},
        "evidence": {"channels": ["bn_xref", "floss"], "string_source": "static",
                     "string_va": None, "string_function_va": None,
...
def _bridge_return_value_stub():
    ...
    return {
        "call_site_va": "0x00434d4a", "function_va": "0x00434d20",
        "api_name": "IsDebuggerPresent", "api_resolution": "import",
        "parameter_index": -1, "comparison_operator": "unknown",
        "candidate_values": [
            {"value": None, "represents": "unknown", "retarget_to": None,
             "confidence": 0.0, "source_channels": ["bn_xref"]}],
        "evidence": {"channels": ["bn_xref"], "string_source": None,
                     "string_va": None, "string_function_va": None,
...
def _oracle_return_value_candidate():
    ...
    return {
        "call_site_va": "0x00434d4a", "function_va": "0x00434d20",
        "api_name": "IsDebuggerPresent", "api_resolution": "import",
        "parameter_index": -1, "comparison_operator": "inequality",
        "evasion_tier": "tier_1", "iteration_number": 0,
        "candidate_values": [
            {"value": True, "represents": "debugger_detected", "retarget_to": False,
             "confidence": 0.9, "source_channels": ["bn_xref"]}],
        "coordination_constraint": {"gate_group_id": None, "description": None},
        "evidence": {"channels": ["bn_xref"], "string_source": None,
                     "string_va": None, "string_function_va": None,
                     "dataflow_path": [], "cmp_operand_a": None, "cmp_operand_b": None},
    }
...
def test_derivation_fields_are_report_only_never_fail():
    g = og.grade_candidate(_oracle_array_candidate(), _bridge_array_candidate())
    for name in ("comparison_operator", "evasion_tier", "coordination_constraint",
